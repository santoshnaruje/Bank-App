...
app.get('/user/:accountNumber', async (req, res) => {
    ...
    console.log("called")
    const sql = `SELECT * FROM usertable where accountNumber=${req.params.accountNumber}`;
...
app.post('/login', async (req, res) => {
  ...
  const userQuery = `SELECT * FROM usertable WHERE accountNumber = '${accountNumber}';`;
...
app.get('/transactions/:accountNumber', async (req, res) => {
  ...
  const sql = `SELECT * FROM transactions 
               WHERE senderAccountNumber = ${req.params.accountNumber} `;
